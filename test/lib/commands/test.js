...
t.test('should run test script with a shell relative to the package', async t => {
  ...
  await npm.exec('test', ['foo'])
  t.ok(script.called, 'script ran with the package-local shell')
})
